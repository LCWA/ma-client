            ...
            >
              ...
              <div className="person">
                ...
                <p className="member-description body-text">
                  ...
                  project manager. She has an innate talent for helping teams
                  stay organized and efficient in complex projects with rapidly
                  changing priorities.
                </p>
              </div>
              <div className="person">
                ...
                <p className="member-description body-text">
                  ...
                  has previous experience with a variety of programming
                  languages. Recently, she has dedicated a lot of her focus on
              ...
              <div className="person">
                ...
                <p className="member-description body-text">
                  ...
                  continuously applied her knowledge while working with
                  different tools on a variety of projects.
                </p>
              </div>
            </OwlCarousel>
          </div>
