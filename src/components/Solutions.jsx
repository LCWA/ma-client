        ...
        <div className="card-wrapper">
          <div className="solution websites">
            ...
            <p className="body-text description">
              A website is a necessity and no longer an option in order to make
              your business excel.
              <span id="dots">...</span>
          ...
          <div className="solution automation-tools">
            ...
            <p className="body-text description">
              ...
              <span id="more-text-two">
                <br></br>
                You will get assistance with creating and managing ad campaigns
                as well as an understanding of your important keywords and SEO
                strategies.
                <span className="contact-notice">
